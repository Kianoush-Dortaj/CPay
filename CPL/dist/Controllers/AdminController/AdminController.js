...
exports.default = new class AdminController extends BaseController_1.BaseController {
    constructor() {
        super();
    }
    /***
    ...
    Create(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                ...
                const createAdmin = yield UnitOfWork_1.default.adminRepository.RegisterAdmin({
                    name: firstName,
                    gender,
                    password,
                    family: lastName,
    ...
    Update(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                ...
                const updateUser = yield UnitOfWork_1.default.adminRepository
                    .UpdateUserInfo({
                    file: req.file,
                    firstName: firstName,
                    gender,
    ...
    EditAccountInfoUser(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                ...
                const accountInfo = yield UnitOfWork_1.default.adminRepository.UpdateAccountInfo(userId, email, isActive);
    ...
    ChangePassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                ...
                const changePassword = yield UnitOfWork_1.default.adminRepository.ChangePassword({
                    password: password,
                    userId: userId
                });
     ...
     * Change UserRole
     */
    ChangeUseRole(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let validationData = yield this.ValidationAction(req, res);
            if (!validationData.haveError) {
                const userId = req.params.id;
                const { roles } = req.body;
                const changePassword = yield UnitOfWork_1.default.adminRepository.ChangeUserRole(userId, roles);
                if (changePassword.success) {
                    return this.Ok(res, "Success Change Password");
                }
                return this.BadRerquest(res, changePassword.message);
    ...
    GetUserInfoAccount(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                const userId = req.params.id;
                const getManagerAccountInfo = yield UnitOfWork_1.default.adminRepository.GetManagerAccountInfo(userId);
    ...
    */
    GetUserPersonalInformation(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                const userId = req.params.id;
                const getManagerPersonalInfo = yield UnitOfWork_1.default.adminRepository.GetManagerInformation(userId);
    ...
    GetUserRoles(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validationData.haveError) {
                const userId = req.params.id;
                const getUserRoles = yield UnitOfWork_1.default.adminRepository.GetUserroles(userId);
    ...
    */
    ...
    GetAllManagerPaging(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let Managers = yield UnitOfWork_1.default.adminRepository.GetAllManagerPaging(req.body);
