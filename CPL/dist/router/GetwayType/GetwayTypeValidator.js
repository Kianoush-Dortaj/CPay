...
exports.default = new class GetwayTypeValidation {
    CreateHandle() {
        return [
            (0, express_validator_1.check)("name").notEmpty().withMessage("Name Can not be Empty"),
            (0, express_validator_1.check)("description").notEmpty().withMessage("description Can not be Empty"),
    ...
    UpdateHandle() {
        return [
            (0, express_validator_1.query)("id").custom((value, { req }) => __awaiter(this, void 0, void 0, function* () {
                if (req.params) {
                    let data = yield UnitOfWork_1.default.GetwayTypeRepository
