...
exports.default = new class FiatCurrencyValidation {
    CreateHandle() {
        return [
            (0, express_validator_1.check)("name").notEmpty().withMessage("name Can not be Empty"),
            (0, express_validator_1.check)("currencyCode").notEmpty().withMessage("currencyCode Can not be Empty"),
            ...
            (0, express_validator_1.check)("logo").custom((value, { req }) => __awaiter(this, void 0, void 0, function* () {
                if (req.file) {
