...
//   async search(search, filter = '', symbol, exchangeB) {
...
//     const findData = data.find(s => s.exchange == exchangeB && s.symbol == symbol);
...
//     //   console.log(exchangeB + ' ' + s.exchange, symbol + ' ' + s.symbol, s.exchange.toString() == exchangeB.toString() && s.symbol.toString() == symbol.toString())

//     //   if (s.exchange.toString() == exchangeB.toString() && s.symbol.toString() == symbol.toString()) {
//     //     exchange = s;
//     //     exchange = s.exchange;
