...
export interface ILoginRepository {
    ...
    ForgetPassword(email: string): Promise<OperationResult<string>>;
    CheckAuthForgetPasswordCode(hash: string, code: string, email: string): Promise<OperationResult<string>>;
}